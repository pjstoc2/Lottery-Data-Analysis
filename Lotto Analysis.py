...
def analyze_lottery():
    ...
    try:
        ...
        # Step 5: Count the frequencies of each number (assumes numbers range from 1 to 40)
        observed_counts = np.zeros(40)  # Create an array for counting numbers from 1 to 40
        ...
        expected_frequency = total_numbers / 40  # Uniform expected distribution across 40 numbers

        # Perform the chi-square test
        chi2_stat, p_value = chisquare(observed_counts, np.full(40, expected_frequency))
        ...
        with open(output_txt_file, 'w') as f:
            f.write("Observed counts for each number (1 to 40):\n")
        ...
        numbers = np.arange(1, 41)  # Update range to 40 numbers
